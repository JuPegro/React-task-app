...
const TaskCard = ({task}) => {
  ...
  return (
    <div className="flex flex-col sm:h-40 justify-center overflow-hidden items-start w-full p-5 gap-2 rounded-md bg-white outline outline-1 outline-slate-300 shadow-slate-400 shadow">
